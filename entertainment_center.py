...
"""
    instances for class Movie:
        title, storyline, poster_image, youtube trailer
"""
the_road = media.Movie("The Road",
                        ...
                        "https://images-na.ssl-images-amazon.com/images/M/MV5BMTAwNzk4NTU3NDReQTJeQWpwZ15BbWU3MDg3OTEyODI@._V1_UY268_CR0,0,182,268_AL_.jpg",
                        "https://www.youtube.com/watch?v=FsFFwaRxoDw")

into_the_wild = media.Movie("Into the Wild",
                            "After graduating from Emory University, top student and athlete Christopher McCandless abandons his possessions, and hitchhikes to Alaska to live in the wilderness.",
...
the_incredibles = media.Movie("The Incredibles",
                              ...
                              "https://lumiere-a.akamaihd.net/v1/images/open-uri20150422-12561-18hpovx_f8238c31.jpeg?region=0,0,300,450",
...
man_on_fire = media.Movie("Man On Fire",
                          ...
                          "https://images-na.ssl-images-amazon.com/images/M/MV5BODFlMmEwMDgtYjhmZi00ZTE5LTk2NWQtMWE1Y2M0NjkzOGYxXkEyXkFqcGdeQXVyNjU0OTQ0OTY@._V1_UY268_CR0,0,182,268_AL_.jpg",
                          "https://www.youtube.com/watch?v=g4kLizDXLY0")

how_i_live_now = media.Movie("How I Live Now",
                             "An American girl, sent to the English countryside to stay with relatives, finds love and purpose while fighting for her survival as war envelops the world around her.",
                             "https://images-na.ssl-images-amazon.com/images/M/MV5BMTU4NTg4NzgzMF5BMl5BanBnXkFtZTgwOTU1NTMxMDE@._V1_UX182_CR0,0,182,268_AL_.jpg",
...
hanna = media.Movie("Hanna",
                    ...
                    "https://images-na.ssl-images-amazon.com/images/M/MV5BNTAzMTg1NjY0NF5BMl5BanBnXkFtZTcwODc3MTgzNA@@._V1_UX182_CR0,0,182,268_AL_.jpg",
...
"""
movies = [the_road, into_the_wild, the_incredibles, man_on_fire, how_i_live_now, hanna]
